// tu_mutex.cpp	-- Vitaly Alexeev <vitaly.alexeev@yahoo.com>	2009

// This source code has been donated to the Public Domain.  Do
// whatever you want with it.

#include "bakeinflash_mutex.h"
...
namespace bakeinflash
{
	...
	{
		IF_VERBOSE_ACTION(myprintf("SDL thread is started\n"));
		m_func = fn;
		m_arg = data;
...
namespace bakeinflash
{
	...
	tu_thread::tu_thread(void (*fn)(void *), void* data)
	{
		IF_VERBOSE_ACTION(myprintf("pthread is started\n"));
		m_func = fn;
		m_arg = data;
		if (pthread_create(&m_thread, NULL, pthread_start_func, this))
		{
			myprintf("Couldn't create the pthread\n");
		}
	}
