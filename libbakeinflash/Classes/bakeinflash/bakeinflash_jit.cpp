// bakeinflash_jit.cpp	-- Julien Hamaide <julien.hamaide@gmail.com>	2008
...
namespace bakeinflash
{
	...
	{
		m_executable_byte_code = &m_work_byte_code[0]; //valloc(m_work_byte_code.size());
		...
		bool rc = VirtualProtectEx(Server, &m_work_byte_code[0], m_work_byte_code.size(), PAGE_EXECUTE_READWRITE, &OLDPROTECT);
