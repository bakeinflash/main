// tu_mutex.h	-- Vitaly Alexeev <vitaly.alexeev@yahoo.com>	2007

// This source code has been donated to the Public Domain.  Do
// whatever you want with it.

#ifndef BAKEINFLASH_MUTEX_H
#define BAKEINFLASH_MUTEX_H
...
namespace bakeinflash
{
	struct tu_thread : public ref_counted
	{
		 tu_thread(void (*fn)(void *), void* data)
		{
			IF_VERBOSE_ACTION(myprintf("bakeinflash is in single thread mode\n"));
			(fn)(data);
		}
