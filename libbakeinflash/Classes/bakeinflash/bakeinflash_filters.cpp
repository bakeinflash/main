// bakeinflash_filters.cpp	-- Julien Hamaide <julien.hamaide@gmail.com> 2008
	...
	void read_filter_list( stream* in )
	{
		...
		for (int i = 0; i < filters; i++)
		{
			...
			case 0 : // DropShadowFilter
				{
					...
					IF_VERBOSE_PARSE(myprintf("  filter = DropShadowFilter\n" ));
			...
			case 1 : // BlurFilter
				{
					...
					IF_VERBOSE_PARSE(myprintf("  filter = BlurFilter\n" ));
			...
			case 2 : // GlowFilter
				{
					...
					in->read_u8();// If not present, when parsing several filters, filter type is not correct
					IF_VERBOSE_PARSE(myprintf("  filter = GlowFilter\n" ));
			...
			case 3 : // BevelFilter
				{
					...
					in->read_u8();// If not present, when parsing several filters, filter type is not correct
					IF_VERBOSE_PARSE(myprintf("  filter = BevelFilter\n" ));
			...
			case 4 : // GradientGlowFilter
				{
					...
					IF_VERBOSE_PARSE(myprintf("  filter = GradientGlowFilter\n" ));
					break;
				}
			...
			case 5 : // ConvolutionFilter
				{
					...
					IF_VERBOSE_PARSE(myprintf("  filter = ConvolutionFilter\n" ));
			...
			case 6 : // ColorMatrixFilter
				...
				IF_VERBOSE_PARSE(myprintf("  filter = ColorMatrixFilter\n" ));
				break;
			...
			case 7 : // GradientBevelFilter
				{
					...
					int passes = in->read_uint(4); // passes
					in->read_u8();// If not present, when parsing several filters, filter type is not correct
					IF_VERBOSE_PARSE(myprintf("  filter = GradientBevelFilter\n" ));
