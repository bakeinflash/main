...
namespace bakeinflash
{
	...
	static as_color_transform_member   get_color_transform_member(const tu_string& name);
	...
	bool	as_color_transform::set_member(const tu_string& name, const as_value& val)
	{
	...
	bool	as_color_transform::get_member(const tu_string& name, as_value* val)
	{
		as_color_transform_member member = get_color_transform_member( name );
	...
	as_color_transform_member	get_color_transform_member(const tu_string& name)
	{
