...
namespace bakeinflash
{
	...
	void	as_point_add(const fn_call& fn)
	{
		...
		{
			smart_ptr<as_point>	obj;
			obj = new as_point(point->m_point.m_x + other_point->m_point.m_x,
	...
	bool	as_point::set_member(const tu_string& name, const as_value& val)
	{
		if (name == "x" )
		{
	...
	bool	as_point::get_member(const tu_string& name, as_value* val)
	{
		if (name == "x" )
		{
