// bakeinflash_font.h	-- Thatcher Ulrich <tu@tulrich.com> 2003
...
#ifndef BAKEINFLASH_FONT_H
#define BAKEINFLASH_FONT_H
...
namespace bakeinflash
{
	...
	private:
		...
		// Dummy hash functor.
		{
			...
			Uint32	operator()(const T& data) const { return data; }
