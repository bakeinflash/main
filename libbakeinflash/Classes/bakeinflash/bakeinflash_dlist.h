// bakeinflash_dlist.h	-- Thatcher Ulrich <tu@tulrich.com> 2003
...
#ifndef BAKEINFLASH_DLIST_H
#define BAKEINFLASH_DLIST_H
...
namespace bakeinflash
{
	...
	struct display_list
	{
		...
		void	advance_dlist();
		void	advance_actions();
		void	advance_ctor();
		void	load_bitmaps(array < smart_ptr<bitmap_info> >*	m_bitmap_hash);
		...
		character*	get_character(int index) { return m_display_object_array[index].m_character.get(); }
		...
		void set_instance_name(character* ch);
